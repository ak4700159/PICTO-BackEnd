...
from model_train.dataset.ela_dataset import FAILED_ELA_PATHS, convert_to_ela_image
from model_train.utils import pad_to_square

class TamperingEfficientNetClassifier(nn.Module):
    def __init__(self, train_loader, val_loader, device):
        super(TamperingEfficientNetClassifier, self).__init__()
        self.device = device

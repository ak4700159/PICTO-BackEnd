...
public class QSave extends EntityPathBase<Save> {
    ...
    private static final long serialVersionUID = 1223634023L;
    ...
    public final picto.com.generator.domain.photo.domain.QPhoto photo;

    public final NumberPath<Integer> savedTime = createNumber("savedTime", Integer.class);
    ...
    public QSave(Class<? extends Save> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new QSaveId(forProperty("id")) : null;
        this.photo = inits.isInitialized("photo") ? new picto.com.generator.domain.photo.domain.QPhoto(forProperty("photo"), inits.get("photo")) : null;
